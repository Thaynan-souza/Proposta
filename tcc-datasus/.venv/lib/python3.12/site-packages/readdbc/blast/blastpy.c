...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 5), // int()(FILE *, FILE *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // FILE *
/*  2 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  4 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // FILE
/*  5 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
};

static int _cffi_d_dbc2dbf(FILE * x0, FILE * x1)
{
  return dbc2dbf(x0, x1);
}
#ifndef PYPY_VERSION
static PyObject *
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "dbc2dbf", (void *)_cffi_f_dbc2dbf, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_dbc2dbf },
};

static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "_IO_FILE", 4, _CFFI_F_OPAQUE,
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_blastpy(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_blastpy(void) { return NULL; }
#  else
     initblastpy(void) { }
#  endif
#  endif
...
PyInit_blastpy(void)
{
  return _cffi_init("blastpy", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initblastpy(void)
{
  _cffi_init("blastpy", 0x2601, &_cffi_type_context);
}
#endif
